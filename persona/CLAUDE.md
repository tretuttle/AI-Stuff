...
| Technology | Format | Purpose | Why |
|------------|--------|---------|-----|
| `skills/review/SKILL.md` | Markdown with YAML frontmatter | User-facing `/persona:review` command | Skills are how users invoke plugin functionality. The orchestrator skill tells Claude to dispatch to persona agents and synthesize results. |
| `skills/parse-output/SKILL.md` | Markdown with YAML frontmatter | Synthesis skill | Processes raw persona feedback into a unified review. User-invocable for standalone synthesis runs. |
...
| Technology | Format | Purpose | Why |
|------------|--------|---------|-----|
| `skills/review/reference.md` | Markdown | Review conventions and output format spec | Skills can include supporting files alongside SKILL.md. Keeps SKILL.md under 500 lines. |
